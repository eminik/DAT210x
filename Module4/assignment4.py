...
dfTrans = pca.transform(df)

Plot2D(dfTrans, "PCA", 0, 1)
...
iso.fit(df)
dfTrans2 = iso.transform(df)

Plot2D(dfTrans2, "Isomap", 0, 1)


Plot2D(dfTrans2, "Isomap - 2nd and 3rd components", 1, 2)
...
Plot3D(dfTrans2, "Isomap - 3D", 0, 1, 2)
